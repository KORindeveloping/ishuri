...
export const PAST_PAPERS_DATA: PaperMetadata[] = [
  ...
  // Primary (P6 / General)
  { id: 'p6-2018-is', title: 'Integrated Studies', fileName: '2018 Integrated Sciences Past Paper.pdf', subject: 'Integrated Studies', year: 2018, level: 'Primary' },
  { id: 'p6-2021-mi', title: 'Ikinyarwanda', fileName: '2021 Ikinyarwanda Past Paper.pdf', subject: 'Ikinyarwanda', year: 2021, level: 'Primary' },
  { id: 'p6-2021-i2', title: 'Ikinyarwanda II', fileName: '2021 Ikinyarwanda Past Paper_2.pdf', subject: 'Ikinyarwanda', year: 2021, level: 'Primary' },
  { id: 'p6-2021-m', title: 'Mathematics', fileName: '2021 Mathematics Past Paper.pdf', subject: 'Mathematics', year: 2021, level: 'Primary' },
  { id: 'p6-2021-set', title: 'SET', fileName: '2021 Science _ Elementary Technology Past Paper.pdf', subject: 'SET', year: 2021, level: 'Primary' },
  ...
  { id: 'p6-2022-i2', title: 'Ikinyarwanda II', fileName: '2022 Ikinyarwanda Past Paper_2.pdf', subject: 'Ikinyarwanda', year: 2022, level: 'Primary' },
  { id: 'p6-2022-m', title: 'Mathematics', fileName: '2022 Mathematics Past Paper.pdf', subject: 'Mathematics', year: 2022, level: 'Primary' },
  { id: 'p6-2022-set', title: 'SET', fileName: '2022 Science & Elementary Technology Past Paper.pdf', subject: 'SET', year: 2022, level: 'Primary' },
  ...
  { id: 'p6-2023-i2', title: 'Ikinyarwanda II', fileName: '2023 Ikinyarwanda Past Paper_2.pdf', subject: 'Ikinyarwanda', year: 2023, level: 'Primary' },
  ...
  { id: 's6-2021-bh', title: 'Biology Health Studies', fileName: '2021 Biology Health Sciences Past Paper.pdf', subject: 'Biology', year: 2021, level: 'S6' },
  ...
  { id: 's6-2021-lit', title: 'Literature in English', fileName: '2021 Litrature In English Past Paper.pdf', subject: 'Literature', year: 2021, level: 'S6' },
  ...
  { id: 's6-2022-bh', title: 'Biology Health Studies', fileName: '2022 Biology Health Sciences Past Paper.pdf', subject: 'Biology', year: 2022, level: 'S6' },
  ...
  { id: 's6-2022-lit', title: 'Literature in English', fileName: '2022 Litrature In English Past Paper.pdf', subject: 'Literature', year: 2022, level: 'S6' },
  ...
  { id: 's6-2023-bh', title: 'Biology Health Studies', fileName: '2023 Biology Health Sciences Past Paper.pdf', subject: 'Biology', year: 2023, level: 'S6' },
  ...
  { id: 's6-2023-lit', title: 'Literature in English', fileName: '2023 Literature in English Past Paper.pdf', subject: 'Literature', year: 2023, level: 'S6' },
